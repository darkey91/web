...
public class DatabaseUtils {
    ...
    public static Date findCreationTime(long id, String table) {
        try (Connection connection = getDataSource().getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(
                    "SELECT creationTime FROM " + table + " WHERE id=?")) {
                ...
                throw new RepositoryException("Can't find " + table + " .creationTime by id.");
            }
        } catch (SQLException e) {
            throw new RepositoryException("Can't find " + table + " Article.creationTime by id.", e);
        }
    }

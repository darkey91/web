...
public class UserRepositoryImpl implements UserRepository {
    ...
    private User toUser(ResultSetMetaData metaData, ResultSet resultSet) throws SQLException {
        ...
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            ...
            } else if ("isAdmin".equalsIgnoreCase(columnName)){
    ...
    @Override
    public void changePermission(long userId, boolean value) {
        String query = "UPDATE User SET isAdmin=? WHERE id=?";
        String errorMessage = "Can't set/remove permission";
        DatabaseUtils.executeUpdate(query, errorMessage, value, userId);
    }
